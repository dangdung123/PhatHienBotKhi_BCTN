...
// } while (cin.get() != '\n');
//	//VideoCapture cap(0);
//    VideoCapture cap("Tram4\\Tram4_DLCoBot.avi");// doi duong dan den clip mau co bot khi
//while(i<=99)
//{	
//     cap.read ( frame);
...
// imshow("XL",dst1);
//     char filename[80];
//     sprintf(filename,"Tram4\\COBOT\\DATA_%d.png",i);
...
// } while (cin.get() != '\n');
//// VideoCapture cap1(0);
// VideoCapture cap1("Tram4\\Tram4_DLKBot.avi");// doi duong dan den mau k co bot khi
//while(i<=99)
//{	 
//     cap1.read ( frame);
//     if( frame.empty()) break;
...
// imshow("XL",dst1);
//     char filename[80];
//     sprintf(filename,"Tram4\\KBOT\\DATA_%d.png",i);
//	 imwrite(filename, dst1);
//     i++;
//     char key = waitKey(10);
//     if ( key == 27) break;
