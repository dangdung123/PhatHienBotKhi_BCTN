...
int main() {
	...
	Mat new_image(200, height*width, CV_32FC1);
	int ii = 0;
	...
	CvSVMParams params;
	params.svm_type = CvSVM::C_SVC; // tach hoan hao cua cac lop hoc 
							    //(Tuc la khi du lieu đao tao la khong bi phan chia qua cac lop khac)
	...
	while (1)
	{
		...
		Canny(edges, dst1, 80, 120, 3, false); // lay cac canh, duong vien xung quanh anh
		namedWindow("Tram 1", WINDOW_NORMAL);
		imshow("Tram 1", frame);
		imshow("Normal Video", edges);
		imshow("Video Phan Tich", dst1);
		...
		imshow("Tram 2", frame);
		imshow("Normal Video", edges2);
		imshow("Video Phan Tich", dst2);*/

		/*cap3.read(frame);
		cvtColor(frame, edges3, CV_BGR2GRAY);
		Canny(edges3, dst3, 80, 120, 3, false);
		namedWindow("Tram 3", WINDOW_NORMAL);
		imshow("Tram 3", frame);
		imshow("Normal Video", edges3);
		imshow("Video Phan Tich", dst3);
		...
		imshow("Tram 4", frame);
		imshow("Normal Video", edges4);
		imshow("Video Phan Tich", dst4);*/
	...
	//	SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 8);
		cout << endl << "Tram 1: Co bot khi ";
		}
		else {
	//	SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 15);
		cout << endl << "Tram 1: Khong co bot khi";
	//	Beep(350, 10);
		}

		/*if (res2 > 0) {
			SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 8);
			cout << endl << "Tram 2: Co bot khi ";
		}
		else
		{

			SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 15);
			cout << endl << "Tram 2: Khong co bot khi";
			Beep(350, 10);
		}*/
		...
		/*if (res3 > 0) {
		SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 8);
		cout << endl << "Tram 3: Co bot khi ";
		}
		else
		{
		SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 15);
		cout << endl << "Tram 3: Khong co bot khi";
		Beep(350, 10);
		}
		if (res4 > 0) {
		SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 8);
		cout << endl << "Tram 4: Co bot khi ";
		}
		else
		{

		SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 15);
		cout << endl << "Tram 4: Khong co bot khi";
		Beep(350, 10);
		}*/
